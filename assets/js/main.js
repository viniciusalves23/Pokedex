                             ...
                             <div class="tab-pane fade" id="stats${pokemon.number}" role="tabpanel"
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1-value text-left div_progress d-flex flex-wrap">
                                             ${pokemon.stats.map((stat, index) => `<progress class="base_stat w-100"" value="${pokemon.baseStats[index]}" max="100"></progress>`).join('')}
                                        </div>
